...
if (OPTION_POOL_THREAD_SAFETY)
    target_compile_definitions(${PROJECT_NAME} PRIVATE FPX_POOL_THREAD_SAFETY)
endif()

if (OPTION_POOL_USES_MMAP)
    target_compile_definitions(${PROJECT_NAME} PRIVATE FPX_POOL_USES_MMAP)
endif()

if (OPTION_LOGGER_IS_PROC)
    target_compile_definitions(${PROJECT_NAME} PRIVATE FPX_LOGGER_IS_PROC)
endif()
