#ifndef FLOPPIX_SYSTEM_THREAD_H
#define FLOPPIX_SYSTEM_THREAD_H
...
fpx_err_t fpx_thread_init(fpx_thread_t *thread, fpx_bitmask_t params,
    size_t stack_size, int prio, fpx_thread_function_t start_routine,
    void *arg);
