...
void fpx_log_error(unsigned int level, fpx_logger_t *logger, fpx_err_t err,
    const char *fmt, ...);

fpx_err_t fpx_logger_init(fpx_logger_t **logger);
fpx_err_t fpx_logger_start(fpx_logger_t *logger);
fpx_err_t fpx_logger_add_log_file(fpx_logger_t *logger, unsigned int level,
    const char *fname, size_t size);
fpx_err_t fpx_logger_add_log_fd(fpx_logger_t *logger, unsigned int level,
    fpx_fd_t fd);
