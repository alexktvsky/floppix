#ifndef FPX_SYSTEM_NET_SOCKET_H
#define FPX_SYSTEM_NET_SOCKET_H
...
fpx_err_t fpx_socket_init(fpx_socket_t *sockfd, int domain, int type,
    int protocol);
fpx_err_t fpx_socket_bind(fpx_socket_t sockfd,
    const struct sockaddr *addr, fpx_socklen_t addrlen);
fpx_err_t fpx_socket_listen(fpx_socket_t sockfd, int backlog);
fpx_err_t fpx_socket_accept(fpx_socket_t *new_sockfd,
    fpx_socket_t sockfd, struct sockaddr *addr, fpx_socklen_t *addrlen);
fpx_err_t fpx_socket_connect(fpx_socket_t sockfd,
    const struct sockaddr *addr, fpx_socklen_t addrlen);
fpx_err_t fpx_socket_shutdown(fpx_socket_t sockfd, int how);
void fpx_socket_close(fpx_socket_t sockf);

#endif /* FPX_SYSTEM_NET_SOCKET_H */
