...
#define fpx_file_change_access(name, access) chmod((const char *) name, access)

#define fpx_file_rename(from, to)            rename((const char *) from, (const char *) to)
...
#define fpx_dir_current_namelen(dir) fpx_strlen(fpx_dir_current_name(dir))
