...
#define fpx_unit_test(name)                                                    \
    {                                                                          \
        name, #name                                                            \
    }
#define fpx_null_test                                                          \
    {                                                                          \
        NULL, NULL                                                             \
    }
...
#define fpx_init_suite_tests(name, ...)                                        \
    fpx_unit_test_t fpx_##name##_suite_tests[] = {__VA_ARGS__, fpx_null_test}; \
    fpx_suite_tests_t fpx_##name##_suite = {fpx_stringify(name),               \
